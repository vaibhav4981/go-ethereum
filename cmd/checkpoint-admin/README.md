...
```shell
go get github.com/TechPay-io/go-ethereum/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/TechPay-io/go-ethereum/blob/master/params/config.go#L251).*
