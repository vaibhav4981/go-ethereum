...
```shell
go get github.com/vaibhav4981/go-ethereum/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/vaibhav4981/go-ethereum/blob/master/params/config.go#L251).*
